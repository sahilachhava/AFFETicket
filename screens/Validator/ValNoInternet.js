...
export default class NoInternet extends Component{
    ...
    componentDidMount(){
      const validator = this.props.navigation.state.params ? this.props.navigation.state.params.validator : null;
      if(validator != null){
        ...
        NetInfo.isConnected.addEventListener(
            ...
            if(hasInternetConnection){
                setTimeout(()=>{
                    ...
                    this.props.navigation.navigate("ValDashboard", {validator: this.state.validatorData});
                },
                1000);
            }else{
                setTimeout(()=>{
                    this.setState({status : false});
                    this.props.navigation.navigate("NoInternet", {validator: this.state.validatorData});
                },
                1000);
            }
        });
